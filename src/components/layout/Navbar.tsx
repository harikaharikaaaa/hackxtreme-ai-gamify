      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        ...
        <div className="container mx-auto px-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <Button onClick={handleAuthButtonClick} className="ml-4 btn-cyber">
              {isAuthenticated ? (
            ...
            {isAuthenticated && (
              <div className="text-cyber-light ml-2">
                <span className="mr-1">|</span> Hi, <span className="text-cyber-blue">{user?.username}</span>
              </div>
            )}
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-cyber-darker border-t border-cyber-blue/20">
            <div className="container mx-auto px-4 py-4 flex flex-col space-y-4">
              ...
              {isAuthenticated && (
                <div className="text-cyber-light py-2">
                  Hi, <span className="text-cyber-blue">{user?.username}</span>
                </div>
              )}
              ...
              >
                {isAuthenticated ? 'Logout' : 'Join Now'}
              </Button>
            </div>
          </div>
        )}
